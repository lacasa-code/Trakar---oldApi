...
return [
    ...
    'enter_userid_id'       => 'select related account',
	...
	'login_email_required'      => 'enter email',
	'login_email_regex'         => 'enter valid email format',
	'login_password_required'   => 'enter password',


	'prod_image_file'        => 'please enter valid image',
    'prod_image_file'        => 'please enter valid image',
    'prod_image_mimes'       => 'please enter valid image extension',
    'prod_image_max'         => 'max image size is 1 MB',


    'phone_no_required'      => 'please enter your phone number',
    'phone_no_min'           => 'phone number should be at least 10 digits',
    'phone_no_max'           => 'phone number should not exceed 17 digits',
];