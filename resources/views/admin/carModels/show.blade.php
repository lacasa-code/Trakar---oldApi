...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#car_model_products" role="tab" data-toggle="tab">
                {{ trans('cruds.product.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="car_model_products">
            @includeIf('admin.carModels.relationships.carModelProducts', ['products' => $carModel->carModelProducts])
        </div>
    </div>
</div>
