...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#categoryid_car_mades" role="tab" data-toggle="tab">
                {{ trans('cruds.carMade.title') }}
            </a>
        </li>
    </ul>
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="categoryid_car_mades">
            @includeIf('admin.productCategories.relationships.categoryidCarMades', ['carMades' => $productCategory->categoryidCarMades])
        </div>
    </div>
</div>
