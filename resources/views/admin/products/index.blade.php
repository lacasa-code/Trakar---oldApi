            ...
            <thead>
                ...
                <tr>
                    ...
                    <td>
                        <select class="search">
                            ...
                            @foreach($car_models as $key => $item)
                                <option value="{{ $item->carmodel }}">{{ $item->carmodel }}</option>
                            @endforeach
                        </select>
                    </td>
                    <td>
                    ...
                    <td>
                        <select class="search">
                            <option value>{{ trans('global.all') }}</option>
                            @foreach($part_categories as $key => $item)
...
{ data: 'car_made_car_made', name: 'car_made.car_made' },
{ data: 'car_model_carmodel', name: 'car_model.carmodel' },
{ data: 'year_year', name: 'year.year' },
{ data: 'part_category_category_name', name: 'part_category.category_name' },
{ data: 'name', name: 'name' },
