...
تم الموافقة على إضافة المنتج الآتي بياناته في متجركم:

<ul style="width: 300px;">
    <li style="text-align: left;"> {{ $prod_name }} </li>
    <li style="text-align: left;"> SN:{{ $prod_serial }} </li>
    <li style="text-align: left;"> {{ $prod_type }} </li>
</ul>
...
<p style="text-align: left;"><strong><span style="font-family: arial, helvetica, sans-serif; font-size: 18pt;">Hello {{ $vendor_name }},</span></strong></p>
<p style="text-align: left;"><span style="font-family: arial, helvetica, sans-serif;">

Adding the product with the following info to your store has been approved:
