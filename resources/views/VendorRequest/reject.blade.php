...
نأسف لإبلاغكم بأنه لم يتم قبول طلب حسابكم للبيع على تركار وذلك للأسباب التالية:
<br>

{{ $reason }}

<br>
 لديك مشكلة في البيانات التالية :- 
<br>
...
Hello, {{ $name }}
 <br>
We are sorry to inform you that your vendor account request has not been approved for the following reasons:
<br>
{{ $reason }}
 <br>
  you have a problem with following data :- 
<br>
