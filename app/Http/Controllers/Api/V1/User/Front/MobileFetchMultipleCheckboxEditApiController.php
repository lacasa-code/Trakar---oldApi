...
class MobileFetchMultipleCheckboxEditApiController extends Controller
{
    public function getLang()
  {
    ...
    public function fetch_multiple_checkbox_mobile(Request $request)
    {
    	//return $request->all();
        $lang = $this->getLang();
    ...
    public function part_categories_search($part_categories, $page, $ordered_by, $sort_type, $PAGINATION_COUNT)
    {
        ...
        $total = Product::where('approved', 1)->where('producttype_id', 1)
        ...
        $total = Product::where('approved', 1)->whereIn('producttype_id', [1, 2, 3])
                        ->whereIn('category_id', $part_categories)->count();
        foreach ($new_products as $new_product) {
                $new_product['in_cart']       = $user->revise_cart($new_product->id);
                $new_product['in_wishlist']   = $user->revise_wishlist($new_product->id);
