...
namespace App\Http\Resources\Api\V1\Admin\Dashboard\Products;
...
class SearchProductsApiResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
       // return parent::toArray($request);
        return[
           ...
           // "parent"        => $this->allcategory_id == null ? null : new SpecificParentApiResource($this->allcategory->parent),
            ...
            'car_model'            => $this->car_model,// ->carmodel,
           ...
           // 'category_details'     => $this->category,//->name,
            ...
            'wishlist_enable'      => $this->quantity <= 0 && $this->producttype_id == 1 ? 0 : 1,
            'media'                => $this->media,
            'photo'                => $this->photo,
            ...
            'tags'          => ProductGetsItsTagsResource::collection($this->tags),
       ...
       /* return[
           ...
           // 'year_id'              => $this->year_id,
            ...
            'part_category_name'   => $this->part_category_id == null ? null : $this->part_category->category_name,
            'category_id'          => $this->category_id,
            'category_name'        => $this->part_category->category->name,
            'vendor_id'            => $this->vendor_id,
            'vendor_name'          => $this->vendor->vendor_name,
            'store_id'             => $this->store_id,
            'store_name'           => $this->store->name,
            ...
            'count_views'          => $this->views->count(), 
            'avg_valuations'       => $this->productreviews->avg('evaluation_value') == null ? 0 : round($this->productreviews->avg('evaluation_value'), 1), 
            'cart_enable'          => $this->quantity <= 0 ? 0 : 1,
            'wishlist_enable'      => $this->quantity <= 0 ? 0 : 1,
            'media'                => $this->media,
            'photo'                => $this->photo,
            'approved'      => $this->approved,
            'serial_id'      => $this->serial_id,
