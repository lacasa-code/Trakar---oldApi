...
class AllcategoryFrontProductsApiResource extends JsonResource
{
    /**
...
// 
           ...
           // 'category_details'     => $this->category,//->name,
            ...
            'transmission_name'    => $this->transmission_id == null ? null : (\Config::get('app.locale') == 'ar' && $this->transmission->transmission_name != null ? $this->transmission->transmission_name : $this->transmission->name_en),
           ...
           'time_created'         => Carbon::createFromFormat('Y-m-d H:i:s', $this->created_at)
             ...
             //'cat_name'            => $this->cat_name->name,
             //'part_name'           => $this->part_name->category_name,
        ];
    }
}
